...
public class ClientOrderAdapter extends RecyclerView.Adapter<ClientOrderAdapter.MyReserveViewHolder>{

    Context context;
    List<Order> orderList;


    public ClientOrderAdapter(Context context, List<Order> orderList) {
